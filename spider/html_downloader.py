...
if __name__ == "__main__":
    ...
    htm=downloader.download('https://book.douban.com/tag/%E5%B0%8F%E8%AF%B4').decode('utf-8')
    content=open('temp.html','w',encoding='utf-8')#wpf=3&ldr=1&page=1&insf=1&_=1559569199226
    content.write(htm)
    # 1559566851.4734867
    # 1559569199226
    # 1559567213000
